**[分享此页](https://twitter.com/intent/tweet?url=https%3A%2F%2Flearnxinyminutes.com%2Fdocs%2Fzh-cn%2Fvim-cn%2F&text=X分钟速成Y%2C+其中+Y%3Dvim)**
...
源代码下载： [LearnVim-cn.txt](https://learnxinyminutes.com/docs/files/LearnVim-cn.txt)

[Vim](http://www.vim.org/) (Vi IMproved) 是 Unix 上的流行编辑器 vi 的克隆版本。这个文本编辑器 是为性能和提升效率而设计的，并且在大多数基于 unix 的系统上普遍存在。 它有大量的快捷键可用来快速导航到文件的特定位置，以便进行快速编辑。
...
有建议？或者发现什么错误？在Github上[开一个issue](https://github.com/adambard/learnxinyminutes-docs/issues/new)，或者你自己也可以写一个[pull request](https://github.com/adambard/learnxinyminutes-docs/edit/master/zh-cn/vim-cn.html.markdown)！

原著RadhikaG，并由[0个好心人](https://github.com/adambard/learnxinyminutes-docs/blame/master/zh-cn/vim-cn.html.markdown)修改。
...
© 2021 [RadhikaG](https://github.com/RadhikaG)

Translated by: [Jiang Haiyun](https://github.com/haiiiiiyun)